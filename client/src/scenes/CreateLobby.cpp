...
void CreateLobby::initEntities()
{
    ...
    std::shared_ptr<Engine::Entity> goBackButtonEngine = std::make_shared<Engine::Button>(Engine::Point<double>{GO_BACK_BUTTON_POSITION_X, GO_BACK_BUTTON_POSITION_Y}, Engine::Point<double>{GO_BACK_BUTTON_WIDTH, GO_BACK_BUTTON_HEIGHT}, std::move(goBackButtonSprite), &goBackToLobbyList, std::shared_ptr<Engine::AScene>(this));
    ...
    std::shared_ptr<Engine::Entity> goUpButtonEngine = std::make_shared<Engine::Button>(Engine::Point<double>{1310, 432}, Engine::Point<double>{GO_UP_BUTTON_WIDTH, GO_UP_BUTTON_HEIGHT}, std::move(goUpButtonSprite), &increaseNbOfClientsCb, std::shared_ptr<Engine::AScene>(this));
    ...
    std::shared_ptr<Engine::Entity> goDownButtonEngine = std::make_shared<Engine::Button>(Engine::Point<double>{1310, 626}, Engine::Point<double>{GO_DOWN_BUTTON_WIDTH, GO_DOWN_BUTTON_HEIGHT}, std::move(goDownButtonSprite), &decreaseNbOfClientsCb, std::shared_ptr<Engine::AScene>(this));
    ...
    std::shared_ptr<Engine::Entity> createLobbyButtonEngine = std::make_shared<Engine::Button>(Engine::Point<double>{900, 670}, Engine::Point<double>{CREATE_LOBBY_BUTTON_WIDTH, CREATE_LOBBY_BUTTON_HEIGHT}, std::move(createLobbySprite), &goToLobbyWaiting, std::shared_ptr<Engine::AScene>(this));
    ...
    std::shared_ptr<Engine::Entity> nbMaxOfClientsTextEngine = std::make_shared<Engine::Text>(Engine::Point<double>{547, 486}, std::move(nbMaxOfClientsText));
...
std::shared_ptr<NetworkAccess> CreateLobby::getServer() const
{
    return _server;
}
